...
namespace WarehouseManger.Infrastructure.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OPDId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PatientVisit_DoctorDetails_DoctorDetailsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientVisit_DoctorDetailsId",
                table: "PatientVisit",
